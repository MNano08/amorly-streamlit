...
# Config — use your own anon key here
...
if selected_user:
    ...
    # Load matches directly, without expecting foreign key magic
    matches_data = (
    ...
    if matches_data:
        ...
        for match in matches_data:
            ...
            # Decode shared_values if it's JSON
